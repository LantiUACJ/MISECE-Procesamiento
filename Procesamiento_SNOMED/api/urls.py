...
urlpatterns = [
	...
	path('procesarSNOMED/Allergy', views.ProcesarAllergyView, name =  "api-procesarAllergySNOMED"),
	...
	path('procesarSNOMED/MedicationRequest', views.ProcesarMedicationRequestView, name =  "api-procesarMedicationRequestSNOMED"),
